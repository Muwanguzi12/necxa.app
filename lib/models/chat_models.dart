...
class ChatRoom {
  ...
  factory ChatRoom.fromJson(Map<String, dynamic> json) {
    ...
    return ChatRoom(
      ...
      agentId:
          (json['agent_id'] ?? json['other_user_id'] ?? json['other_id'])
              as String?,
      ...
      lastMessageAt: _parseDate(
        json['last_message_at'] ?? json['latest_message_at'],
      ),
  ...
  ChatRoom copyWithUnread(int count) => ChatRoom(
    ...
    otherIsAgent: otherIsAgent,
    otherTrustScore: otherTrustScore,
    myUnread: count,
    metadata: metadata,
  );
}
...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    return ChatMessage(
      ...
      conversationId:
          (json['room_id'] ?? json['conversation_id'] ?? '') as String,
