...
class _NewChatScreenState extends State<NewChatScreen>
  ...
  Future<void> _searchByEmail() async {
    ...
    try {
      ...
      if (res == null) {
        setState(() {
          _emailError = 'No Necxa user found with that email';
      ...
      setState(() {
        _emailError = 'Search failed: ${getUserFriendlyError(e)}';
        _emailSearching = false;
      });
    }
  }
  ...
  Future<void> _loadPhoneContacts() async {
    ...
    if (uniqueVariations.isNotEmpty) {
      try {
        ...
        setState(
          () => _necxaMatches = List<Map<String, dynamic>>.from(matches),
        );
      } catch (e) {
  ...
  Future<void> _loadSavedContacts() async {
    ...
    try {
      final res = await _supabase
          .from('saved_contacts')
          .select(
            'contact_id, nickname, saved_at, profiles:contact_id(id, full_name, avatar_url, is_agent, trust_score)',
          )
  ...
  Future<void> _openChatWith(
    ...
    try {
      final res = await _supabase.rpc(
        ...
        params: {'p_user_a': widget.state.user?.id, 'p_user_b': otherUserId},
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Failed to initialize chat: ${getUserFriendlyError(e)}',
            ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Enter a Necxa user\'s email address',
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(14),
                    boxShadow: [
                      BoxShadow(color: C.brand.withOpacity(.3), blurRadius: 12),
                    ],
                  ),
  ...
  Widget _buildContactsTab() {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Find which of your contacts are on Necxa',
                style: dm(sz: 13, c: C.dim),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Allow Access',
                    style: syne(sz: 15, w: FontWeight.w800, c: Colors.black),
                  ),
                ),
              ),
            ],
    ...
    final matchPhones = _necxaMatches
        .map((m) => m['phone'].toString().replaceAll(RegExp(r'\D'), ''))
        .toSet();
              ...
              if (filteredMatches.isEmpty && otherContacts.isEmpty)
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      'No contacts found matching "$_contactFilter"',
                      style: dm(sz: 14, c: C.dim),
                    ),
                  ),
                ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  contact.displayName,
                  style: syne(sz: 14, w: FontWeight.w600),
                ),
          ...
          GestureDetector(
            onTap: () {
              Share.share(
                'Hey! Join me on Necxa, the ultimate mission control for financial freedom. Download here: https://necxa.app',
              );
            },
            child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: syne(sz: 18, w: FontWeight.w700),
            ),
            const SizedBox(height: 6),
            Text(
              'Contacts you chat with will appear here',
              style: dm(sz: 13, c: C.dim),
            ),
          ],
        ),
              ...
              children: [
                ...
                if (user['is_agent'] == true) ...[
                  ...
                  Container(
                    ...
                    child: Text(
                      'Verified Agent',
                      style: dm(sz: 10, c: C.gold, w: FontWeight.w600),
                    ),
                  ),
                ],
              ],
  ...
  Widget _chatBtn(Map<String, dynamic> user) => GestureDetector(
    ...
    child: Container(
      ...
      child: Text(
        'Chat',
        style: syne(sz: 13, w: FontWeight.w800, c: Colors.black),
      ),
    ),
  );
